...
export const Navbar = ({
    ...
    return (
       <nav className="flex justify-between items-center gap-x-2 bg-sidebar border-b">
        <div className="flex items-center gap-x-2">
            ...
            <BreadcrumbList className="gap-0!">
                ...
                <BreadcrumbPage 
                onClick ={handleStartRename}className=" text-sm cursor-pointer hover:text-primary font-medium max-w-40 truncate">
