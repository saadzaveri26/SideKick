...
const ContinueCard = ({
    ...
    return (
        <div className="flex flex-col gap-2">
            <span className="text-xs text-muted-foregrond">Last Updated
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex items-center justify-between gap-2">
                        <span className="text-xs text-muted-foreground">
                            ...
                            <button 
                            onClick={onViewAll}className="flex items-center gap-2 text-muted-foreground text-xs hover:text-foreground transition-colors">
                                <span>
                                    View All
                                </span>
